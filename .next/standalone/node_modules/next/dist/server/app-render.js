...
var _runWithRequestAsyncStorage = require("./run-with-request-async-storage");
var _runWithStaticGenerationAsyncStorage = require("./run-with-static-generation-async-storage");
 ...
 */ function createErrorHandler(/**
   * Used for debugging
   */ _source, isNextExport, capturedErrors, allCapturedErrors) {
    return (err)=>{
        var ref, ref1;
...
function patchFetch(ComponentMod) {
    ...
    globalThis.fetch = async (input, init)=>{
        ...
        if (!staticGenerationStore.revalidate || typeof revalidate === "number" && revalidate < staticGenerationStore.revalidate) {
...
async function renderToHTMLOrFlight(req, res, pathname, query, renderOpts) {
     ...
     */ const requestId = (0, _indexCjs).nanoid(12);
         ...
         */ const renderComponentsOnThisLevel = // No further router state available
            ...
            const flightData = [
                (await walkTreeWithFlightRouterState({
                    ...
                    isFirst: true,
                    rscPayloadHead: /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/ _react.default.createElement(_metadata.Metadata, {
                        key: requestId,
     ...
     */ const ServerComponentsRenderer = createServerComponentRenderer(async ()=>{
            ...
            return /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/ _react.default.createElement(AppRouter, {
                ...
                initialHead: /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/ _react.default.createElement(_metadata.Metadata, {
                    key: requestId,
                    metadata: metadataItems
                }), initialHead),
